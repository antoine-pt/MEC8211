...
def Position(prm):
    ...
    Entrées:
        - prm : Paramètres
            - prm.Rmax : Borne supérieure du domaine en r, Borne inférieure de R étant à l'origine
        ...
        - r : Matrice (array) de dimension (nr x nz) qui contient la position en r
            ...
            * Avec nr = 3 et nz = 3
                ...
                z = [[0. 1. 2.]
                     ...
                     [0. 1. 2.]]
    """
    rvector = np.linspace(0, prm.Rmax, prm.nr) + 5
    zvector = np.linspace(0, prm.H/2, prm.nz) - 100
